...
test_cases = [
    ...
    ([5, -3, 5], 7),
    ([-2, 1, -3, 4, -1, 2, 1, -5, 4], 6),
    ([1, -1, 1, -1, 1, -1], 1),  # FIXED: Expected 1, not 3
    ([-2, -3, -1, -4], -1),
    ([1], 1),
    ([], 0),
    ([3, 2, -1], 3),
...
for i, (inp, expected) in enumerate(test_cases, 1):
    ...
    print(f"Test {i} {status}: Input {inp} | Expected {expected} | Got {result}")
...
#   Test 4 PASS: Input [1, -1, 1, -1, 1, -1] | Expected 1 | Got 1
#   Test 5 PASS: Input [-2, -3, -1, -4] | Expected -1 | Got -1
#   Test 6 PASS: Input [1] | Expected 1 | Got 1
#   Test 7 PASS: Input [] | Expected 0 | Got 0
#   Test 8 FAIL: Input [3, 2, -1] | Expected 3 | Got 5
#   Test 8 FAIL: Input [3, 2, -1] | Expected 3 | Got 5
#   Test 9 PASS: Input [-1, -2, -3] | Expected -1 | Got -1
#   Test 10 PASS: Input [5, 10, 5, 1] | Expected 21 | Got 21
#   
