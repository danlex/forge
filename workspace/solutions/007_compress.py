...
def compress(lst):
    """Return run-length encoded version of a list as [(value, count), ...]"""
    ...
    # FLUSH the last group - this is the key insight!
    # The loop ends before we emit the final accumulated group
    result.append((prev, count))
